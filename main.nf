...
// SUBWORKFLOWS
//
include { PIPELINE_COMPLETION       } from './subworkflows/local/utils_hofflab_phageannotator_pipeline'
include { PIPELINE_INITIALISATION   } from './subworkflows/local/utils_hofflab_phageannotator_pipeline'
include { methodsDescriptionText    } from './subworkflows/local/utils_hofflab_phageannotator_pipeline'
